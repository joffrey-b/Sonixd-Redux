...
function setupBridge(setCredentialsResult: boolean | Promise<boolean> = true) {
  (window as unknown as { bridge: Window['bridge'] }).bridge = {
    settings: {
      ...
      getCachePath: jest.fn().mockResolvedValue(undefined),
      getDownloadPath: jest.fn().mockResolvedValue(undefined),
      clearDownloadPath: jest.fn().mockResolvedValue({ success: true }),
    },
    osRelease: '',
    ...
    downloadDir: {
      ...
      removeDirIfEmpty: jest.fn().mockResolvedValue(true),
    },
    recovery: {
      write: jest.fn().mockResolvedValue(undefined),
      read: jest.fn().mockResolvedValue(null),
