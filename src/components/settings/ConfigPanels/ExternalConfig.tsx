  ...
  return (
    <ConfigPanel bordered={bordered} header={t('External')}>
      ...
      <ConfigPanel header="Discord" collapsible $noBackground>
        ...
        <ConfigOption
          ...
          description={
            <Trans t={t}>
              ...
              . The large icon uses the name "icon". Default is 1499423307420795021.
            </Trans>
          }
          option={
            <StyledInput
        ...
        />
        <ConfigOption
          name={t('Display Album Art')}
          description={t(
            'Shows the album art of the currently playing song in Discord, fetched from iTunes.'
          )}
          option={
            <StyledToggle
              ...
              onChange={(e: boolean) => {
                ...
                dispatch(setDiscord({ ...config.external.discord, showAlbumArt: e }));
              }}
            />
          }
        />
