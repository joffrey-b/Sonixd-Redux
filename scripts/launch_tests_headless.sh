...
# headless (via Xvfb — Electron still needs a display server, just a virtual one).
...
echo "Running E2E tests (headless via Xvfb)..."
xvfb-run -a --server-args="-screen 0 1920x1080x24" yarn e2e
